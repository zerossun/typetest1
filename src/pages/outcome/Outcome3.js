    ...
    <div className='result'>
        ...
        <div className='down'>
            <div className="sns">
                ...
                <FacebookShareButton style={{ marginLeft: "16px" }} url={"https://virtupiaotakutest.netlify.app/Outcome3"}>
                  <img src={Facebook} style={{width:'50px'}}></img>
                </FacebookShareButton>
                <LineShareButton style={{ marginLeft: "16px" }} url={"https://virtupiaotakutest.netlify.app/Outcome3"}>
                  <img src={line} style={{width:'50px'}}></img>
                </LineShareButton>
                <TwitterShareButton style={{ marginLeft: "16px" }} url={"https://virtupiaotakutest.netlify.app/Outcome3"}>
